...
osql -S %1 -d %2 -E -b -i "CREATE.VIEW.I.A.demographicsChartA.sql"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "CREATE.VIEW.I.B.demographicsChartB.sql"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "CREATE.VIEW.I.C.demographicsChartC.sql"
if %ERRORLEVEL% NEQ 0 goto errors
